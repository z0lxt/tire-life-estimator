...
Tells you if your tire has reached its typical safe limit and should be replaced If not estimated how many more kilometers and years you can expect to use it at maximum
...
Clone this repo or download Main.java
